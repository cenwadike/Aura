...
// export function InteractModal({ open, onOpenChange, avatarId, templateName }: InteractModalProps) {
...
//     try {
//       await x402UpdateAvatarCall(`${API_BASE_URL}/update-avatar`, avatarId, userMessage, address)
//       router.refresh();
//     } catch (error) {
